...
def update_or_create_user_tokens(session_key, access_token, token_type, expires_in, refresh_token):
    ...
    if tokens:
        ...
        tokens = SpotifyToken(
            user=session_key, access_token=access_token,  refresh_token=refresh_token, expires_in=expires_in, token_type=token_type)
        tokens.save()
...
def refresh_spotify_token(session_key):
    ...
    update_or_create_user_tokens(
        session_key, access_token, token_type, expires_in)
